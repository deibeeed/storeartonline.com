...
<!--                </div>-->
        ...
        <div class="pull-right" style="margin-top: 25px; /*text-align: right;*/ width: 80%; display: inline-block;">
            ...
            <div class="container-new-arrival" style="/*background-color: yellowgreen;*/ text-align: right; /*width: 1020px;*/ margin: 10px; float: right;">
        ...
        <div class="pull-right" style="margin-top: 25px; /*text-align: right;*/ width: 80%; display: inline-block;">
            ...
            <h2 style="/*margin: 0px 50px 0px 248px;*/margin-right: 50px; border: 0; padding: 5px;">
                <a href="#" onclick="menuList('cars')">Car Accessories</a>
                <button class="btn btn-default button-template" style="float: right; background-color: yellowgreen;" onclick="menuList('cars')">see more</button>
            </h2>
            <div class="container-cars" style="/*background-color: yellowgreen;*/ text-align: right; /*width: 1020px;*/ margin: 10px; float: right;">
        ...
        <!-- container 4 -->
        <div style="margin-top: 25px; /*text-align: right;*/ width: 100%; display: inline-block;">

            <h2 style="margin: 0px 50px 0px 248px; border: 0; padding: 5px;">
                <a href="#" onclick="menuList('computer')">Computer Parts & Accessories</a>
                <button class="btn btn-default button-template" style="float: right; background-color: yellowgreen;" onclick="menuList('computer')">see more</button>
            </h2>
            <div class="container-computer" style="/*background-color: yellowgreen;*/ text-align: right; /*width: 1020px;*/ margin: 10px; float: right;">
...
//        });
            ...
            $.ajax({
                ...
                success         : function(msg){
                    ...
                    if(result.status == 'success'){
                        ...
                        for(var i = 0; i < data.length; i++){
                            $('div.container-cars').append('<div style="background-color: #ffffff; display: inline-block; margin: 5px; position: relative; text-align: left; vertical-align: top; white-space: normal;"><div class="item_container" style="width: 160px; height: 160px; display: inline-block" onclick="redirectToItem(' + data[i].product_id + ')"><span style="display: inline-block; height: 100%; vertical-align: middle"></span><img src="../images/product/' + data[i].photo.split(',')[0] + '" style="width: 128px; /*width: 101px;*/ margin-top: 10px; margin-left: 17px; vertical-align: middle;" ></div><div style="box-sizing: border-box; display: block; overflow: hidden; padding: 7px 10px 0; position: relative; margin-bottom: 5px;"><div><a href="#" style="font-size: 14px; color: #000000;">' + data[i].name + '</a></div><div><a href="#" style="color: #333333; font-size: 12px;">' + data[i].brand + '</a></div><div style="margin-top: 10px;"><div class="star-item" style="font-size: 12px; display: inline-block;" data-average="' + (data[i].rate == null ? 0 : data[i].rate) + '"></div><div style="display: inline-block; color: #b3c833; float: right;"><span style="cursor: pointer;">' + data[i].price + '</span></div></div></div></div>');
                        }
                        var script = document.createElement('script');
                        script.type = 'text/javascript';
                        script.text = rating;

                        $('div.container-cars').append(script);
                    }
                },
                error           : function(msg){
            ...
            $.ajax({
                ...
                success         : function(msg){
                    ...
                    if(result.status == 'success'){
                        ...
                        for(var i = 0; i < data.length; i++){
                            $('div.container-computer').append('<div style="background-color: #ffffff; display: inline-block; margin: 5px; position: relative; text-align: left; vertical-align: top; white-space: normal;"><div class="item_container" style="width: 160px; height: 160px; display: inline-block" onclick="redirectToItem(' + data[i].product_id + ')"><span style="display: inline-block; height: 100%; vertical-align: middle"></span><img src="../images/product/' + data[i].photo.split(',')[0] + '" style="width: 128px; /*width: 101px;*/ margin-top: 10px; margin-left: 17px; vertical-align: middle;" ></div><div style="box-sizing: border-box; display: block; overflow: hidden; padding: 7px 10px 0; position: relative; margin-bottom: 5px;"><div><a href="#" style="font-size: 14px; color: #000000;">' + data[i].name + '</a></div><div><a href="#" style="color: #333333; font-size: 12px;">' + data[i].brand + '</a></div><div style="margin-top: 10px;"><div class="star-item" style="font-size: 12px; display: inline-block;" data-average="' + (data[i].rate == null ? 0 : data[i].rate) + '"></div><div style="display: inline-block; color: #b3c833; float: right;"><span style="cursor: pointer;">' + data[i].price + '</span></div></div></div></div>');
                        }
                        var script = document.createElement('script');
                        script.type = 'text/javascript';
                        script.text = rating;

                        $('div.container-computer').append(script);
                    }
                },
                error           : function(msg){
        ...
        function loadItemNewArrival(){
            var rating = "$('div.star-item').jRating({type            : 'small',isDisabled      : true,showRateInfo    : false,rateMax         : 5});";

            $.ajax({
                type            : 'POST',
                url             : '../controller/GetRecord_Controller.php',
                data            : 'action=getItemNewArrival&data=',
                success         : function(msg){
                    console.log(msg);
                    var result = JSON.parse(msg);
                    ...
                    if(result.status == 'success'){
                        ...
                        for(var i = 0; i < data.length; i++){
                            $('div.container-new-arrival').append('<div style="background-color: #ffffff; display: inline-block; margin: 5px; position: relative; text-align: left; vertical-align: top; white-space: normal;"><div class="item_container" style="width: 160px; height: 160px; display: inline-block" onclick="redirectToItem(' + data[i].product_id + ')"><span style="display: inline-block; height: 100%; vertical-align: middle"></span><img src="../images/product/' + data[i].photo.split(',')[0] + '" style="width: 128px; /*width: 101px;*/ margin-top: 10px; margin-left: 17px; vertical-align: middle;" ></div><div style="box-sizing: border-box; display: block; overflow: hidden; padding: 7px 10px 0; position: relative; margin-bottom: 5px;"><div><a href="#" style="font-size: 14px; color: #000000;">' + data[i].name + '</a></div><div><a href="#" style="color: #333333; font-size: 12px;">' + data[i].brand + '</a></div><div style="margin-top: 10px;"><div class="star-item" style="font-size: 12px; display: inline-block;" data-average="' + (data[i].rate == null ? 0 : data[i].rate) + '"></div><div style="display: inline-block; color: #b3c833; float: right;"><span style="cursor: pointer;">' + data[i].price + '</span></div></div></div></div>');
                        }
                        var script = document.createElement('script');
                        script.type = 'text/javascript';
                        script.text = rating;

                        $('div.container-new-arrival').append(script);
                    }
                },
                error           : function(msg){
