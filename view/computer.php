    ...
    <body>
        ...
        <div id="home" class="container">
            ...
            <div class="pull-right" style="margin-top: 25px; /*text-align: right;*/ width: 80%; display: inline-block;">
                ...
                <div class="container-computer-hot-deals" style="/*background-color: yellowgreen;*/ text-align: right; /*width: 1020px;*/ margin: 10px; float: right;">
            ...
            <div class="pull-right" style="margin-top: 25px; /*text-align: right;*/ width: 80%; display: inline-block;">
                ...
                <div class="container-computer-new-arrival" style="/*background-color: yellowgreen;*/ text-align: right; /*width: 1020px;*/ margin: 10px; float: right;">
            ...
            <div class="pull-right" style="margin-top: 25px; /*text-align: right;*/ width: 80%; display: inline-block;">
                ...
                <div class="container-computer-all" style="/*background-color: yellowgreen;*/ text-align: right; /*width: 1020px;*/ margin: 10px; float: right;">
...
//                        alert('Your request has been sent. We will respond to your request as soon as possible. Thank you for your patronage.');
            ...
            function loadItemComputer(){
                ...
                $.ajax({
                    ...
                    data            : 'action=getItemComputer&data=',
                    success         : function(msg){
//                        console.log(msg);
                        var result = JSON.parse(msg);
            ...
            function loadItemComputerNewArrival(){
                var rating = "$('div.star-item').jRating({type            : 'small',isDisabled      : true,showRateInfo    : false,rateMax         : 5});";

                $.ajax({
                    type            : 'POST',
                    url             : '../controller/GetRecord_Controller.php',
                    data            : 'action=getItemComputerNewArrival&data=',
                    success         : function(msg){
//                        console.log(msg);
                        var result = JSON.parse(msg);
                        ...
                        if(result.status == 'success'){
                            ...
                            if(data.length > 0){
                                for(var i = 0; i < data.length; i++){
                                    $('div.container-computer-new-arrival').append('<div style="background-color: #ffffff; display: inline-block; margin: 5px; position: relative; text-align: left; vertical-align: top; white-space: normal;"><div class="item_container" style="width: 160px; height: 160px; display: inline-block" onclick="redirectToItem(' + data[i].product_id + ')"><span style="display: inline-block; height: 100%; vertical-align: middle"></span><img src="../images/product/' + data[i].photo.split(',')[0] + '" style="width: 128px; /*width: 101px;*/ margin-top: 10px; margin-left: 17px; vertical-align: middle;" ></div><div style="box-sizing: border-box; display: block; overflow: hidden; padding: 7px 10px 0; position: relative; margin-bottom: 5px;"><div><a href="#" style="font-size: 14px; color: #000000;">' + data[i].name + '</a></div><div><a href="#" style="color: #333333; font-size: 12px;">' + data[i].brand + '</a></div><div style="margin-top: 10px;"><div class="star-item" style="font-size: 12px; display: inline-block;" data-average="' + (data[i].rate == null ? 0 : data[i].rate) + '"></div><div style="display: inline-block; color: #b3c833; float: right;"><span style="cursor: pointer;">' + data[i].price + '</span></div></div></div></div>');
                                }
                                var script = document.createElement('script');
                                script.type = 'text/javascript';
                                script.text = rating;

                                $('div.container-computer-new-arrival').append(script);


                            }
                            else
                            {
                                $('div.container-computer-new-arrival').parent().css('display', 'none');
//                                for(var i = 0; i < 10; i++){
//                                    $('div.container-computer-new-arrival').append('<div style="background-color: #ffffff; display: inline-block; margin: 5px; position: relative; text-align: left; vertical-align: top; white-space: normal;"><div class="item_container" style="width: 160px; height: 160px; display: inline-block" onclick="redirectToItem(' + "1" + ')"><span style="display: inline-block; height: 100%; vertical-align: middle"></span><img src="../images/product/' + "" + '" style="width: 128px; /*width: 101px;*/ margin-top: 10px; margin-left: 17px; vertical-align: middle;" ></div><div style="box-sizing: border-box; display: block; overflow: hidden; padding: 7px 10px 0; position: relative; margin-bottom: 5px;"><div><a href="#" style="font-size: 14px; color: #000000;">' + "" + '</a></div><div><a href="#" style="color: #333333; font-size: 12px;">' + "" + '</a></div><div style="margin-top: 10px;"><div class="star-item" style="font-size: 12px; display: inline-block;" data-average="' + "" + '"></div><div style="display: inline-block; color: #b3c833; float: right;"><span style="cursor: pointer;">' + "1" + '</span></div></div></div></div>');
//                                }
                            }
            ...
            function seeMore(what){
                if(what == 'hot-deals'){
                    $('div.container-computer-new-arrival').parent().slideUp();
                    $('div.container-computer-all').parent().slideUp();
                    $('div.container-computer-hot-deals').prev().children('button').hide();
                }
                else if(what == 'new-arrival'){
                    $('div.container-computer-hot-deals').parent().slideUp();
                    $('div.container-computer-all').parent().slideUp();
                    $('div.container-computer-new-arrival').prev().children('button').hide();
                }
                else if(what == 'all'){
                    $('div.container-computer-hot-deals').parent().slideUp();
                    $('div.container-computer-new-arrival').parent().slideUp();
                    $('div.container-computer-all').prev().children('button').hide();
                }
            }
                ...
                $.ajax({
                    ...
                    success         : function(msg){
                        ...
                        if(result.status == 'success'){
                            ...
                            for(var i = 0; i < data.length; i++){
                                $('div.container-computer-hot-deals').append('<div style="background-color: #ffffff; display: inline-block; margin: 5px; position: relative; text-align: left; vertical-align: top; white-space: normal;"><div class="item_container" style="width: 160px; height: 160px; display: inline-block" onclick="redirectToItem(' + data[i].product_id + ')"><span style="display: inline-block; height: 100%; vertical-align: middle"></span><img src="../images/product/' + data[i].photo.split(',')[0] + '" style="width: 128px; /*width: 101px;*/ margin-top: 10px; margin-left: 17px; vertical-align: middle;" ></div><div style="box-sizing: border-box; display: block; overflow: hidden; padding: 7px 10px 0; position: relative; margin-bottom: 5px;"><div><a href="#" style="font-size: 14px; color: #000000;">' + data[i].name + '</a></div><div><a href="#" style="color: #333333; font-size: 12px;">' + data[i].brand + '</a></div><div style="margin-top: 10px;"><div class="star-item" style="font-size: 12px; display: inline-block;" data-average="' + (data[i].rate == null ? 0 : data[i].rate) + '"></div><div style="display: inline-block; color: #b3c833; float: right;"><span style="cursor: pointer;">' + data[i].price + '</span></div></div></div></div>');
                            }
                            var script = document.createElement('script');
                            script.type = 'text/javascript';
                            script.text = rating;

                            $('div.container-car-computer-deals').append(script);
                        }
                    },
                    error           : function(msg){
